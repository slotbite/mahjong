...
const SOUNDS = [
  ...
  // --- sfx ---
  { id: 'flip', kind: 'sfx', src: 'kalimba', lufs: -19, gain: 0.5, af: `asetrate=${SR * 1.75},aresample=${SR},highpass=f=350,lowpass=f=6500,afade=t=in:d=0.003`, maxDur: 0.26, fadeOut: 0.12,
